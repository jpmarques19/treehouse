...
nextStepFile: '{workflow_path}/steps/step-02-detect-branch.md'
---
...
Validate that the base workspace has been initialized with `treehouse-init` before proceeding with context sync.
